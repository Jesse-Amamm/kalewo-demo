...
constructor(props) {
  ...
  render() {
    return (
                    ...
                    <View style={{flexDirection: 'column', width: 300, height: 170, marginLeft: 10}}>
                        <View style={{width: 300, height: 120, marginBottom: 10,}}>
                                <Image resizeMode="cover"
                                   ...
                                   borderRadius: 4, }}
                                   source={require('../lacasa.jpg')}/>
                        </View>
                        <View style={{flexDirection: 'row', justifyContent: 'space-evenly', width: 280}}>
                          <Text style={{fontSize: 14, fontFamily: 'mont-bold', color: '#F2BB66'}}>LA CASA DE PAPEL</Text>
                    ...
                    <View style={{flexDirection: 'column', width: 300, height: 170, marginLeft: 10}}>
                        <View style={{width: 300, height: 120, marginBottom: 10,borderRadius: 4,}}>
                                <Image resizeMode="cover"
                                   ...
                                   source={require('../siliconValley.jpg')}/>
                        </View>
                        <View style={{flexDirection: 'row', justifyContent: 'space-evenly', width: 280}}>
                          <Text style={{fontSize: 14, fontFamily: 'mont-bold', color: '#F2BB66'}}>SILICON VALLEY</Text>
        ...
        onPress={() =>
                ...
                >
                    <View style={{flexDirection: 'column', width: 300, height: 170, marginLeft: 10}}>
                        ...
                        <View style={{flexDirection: 'row', justifyContent: 'space-evenly', width: 280}}>
                          <Text style={{fontSize: 14, fontFamily: 'mont-bold', color: '#F2BB66'}}>GAME OF THRONES</Text>
      ...
      <Image resizeMode={'contain'} source={require('../vikings.jpg')}
      style={{width: '25%', height: 140, borderWidth: 3, borderColor: 'white'}}/>
      <Image resizeMode={'contain'} source={require('../bossBaby.jpg')}
      style={{width: '25%', height: 140, borderWidth: 3, borderColor: 'white'}}/>
      <Image resizeMode={'contain'} source={require('../lionKing.jpg')}
      style={{width: '25%', height: 140, borderWidth: 3, borderColor: 'white'}}/>
      </View>  
          </ScrollView>
      </View>
